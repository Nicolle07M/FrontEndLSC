...
export default function ObjectiveSection() {
  ...
  return (
    <div ref={ref} className="min-h-screen w-full from-black via-gray-900 bg-black relative overflow-hidden flex flex-col justify-center items-center">
      ...
      <motion.img
        src="/src/assets/ai_mano2.png"
        alt="Robot hand"
        className="absolute opacity-40 top-0 right-0 w-250 h-250 object-contain"
      ...
      <motion.img
        src="/src/assets/ai_mano1.png"
        alt="Robot hand"
        className="absolute bottom-0 left-0 w-250 h-250 object-contain"
        variants={animationVariants}
        initial="hidden"
        animate={controls}
      />

      <div className="relative container mx-auto px-20 py-20">
